...
| Efficiency Analysis | How much better the AI is than a fixed-timer light (currently ~9%). |
...
## Project structure
```
simulation/    - intersection simulation, Q-learning AI, fixed-timer baseline
